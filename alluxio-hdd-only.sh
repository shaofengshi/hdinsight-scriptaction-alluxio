...
initialize_alluxio () {
  ...
  echo "alluxio.worker.tieredstore.levels=1" >> ./conf/alluxio-site.properties
  echo "alluxio.worker.tieredstore.level0.alias=HDD" >> ./conf/alluxio-site.properties
  echo "alluxio.worker.tieredstore.level0.dirs.path=/mnt/alluxio-hdd1,/alluxio-hdd2" >> ./conf/alluxio-site.properties
  echo "alluxio.worker.tieredstore.level0.dirs.quota=100GB,200GB" >> ./conf/alluxio-site.properties
